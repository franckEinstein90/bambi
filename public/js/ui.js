...
const eventsUI = (function() {
    ...
    let ui = {
        ...
        renderEventPane = (calendarEvent) => {
            console.log(`${calendarEvent.id},${calendarEvent.eventTitle}`);

        },
        renderEventsView = (calendar) => {
            renderEventsFrame();
            console.log(calendar.size);
            calendar.forEach(renderEventPane);
        }
...
setTitle = () =>{
        ...
        renderCalendar = () =>{
            clear();
            setTitle();
            calendarSettings.weeksSpanned.forEach(addCalendarRow);
        }
