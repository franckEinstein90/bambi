...
describe('flush', function() {
    it('should empty the list of events', function() {
        ...
        expect(eventUtils.size()).to.be.equal(2);
        eventUtils.flush();
        expect(eventUtils.size()).to.be.equal(0);
...
describe('processEventStrArray', function() {
    it('should process a list of events in string format using a function that extracts the event variables', function() {
        ...
        expect(eventUtils.size()).to.be.equal(3);
...
describe('eventsOn', function() {
    it('Returns an array of all calendar events scheduled for the dateStampe passed in as argument', function() {
        ...
        expect(eventUtils.eventsOn('2019_03_15').length).to.be.equal(2);
        expect(eventUtils.eventsOn('2018_03_15').length).to.be.equal(0);
    });
});